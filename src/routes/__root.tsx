...
import { Outlet, Link, createRootRouteWithContext, useNavigate, useRouter, HeadContent, Scripts } from "@tanstack/react-router";
...
function RootComponent() {
  ...
  useEffect(() => {
    return initNativeOAuthListener((search) => {
